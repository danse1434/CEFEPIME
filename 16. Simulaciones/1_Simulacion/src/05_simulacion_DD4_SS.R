...
# CEP 2000mg q12h inf. 30min (DD 4g)
adm1 <- list(time   = seq(0, 12 * 21, by = 12), 
             amount = rep(2000, 22), 
             tinf   = rep(0.5, 22)) 
# CEP 1000mg q6h inf. 30min (DD 4g)
adm2 <- list(time   = seq(0, 6 * 31, by = 6), 
             amount = rep(1000, 32), 
             tinf   = rep(0.5, 32))
# CEP 4000mg q24h inf. 24hrs (DD 4g)
adm3 <- list(time   = c(0.0, seq(0 + 0.5, 24 * 8, by = 24)), 
             amount = c(2000, rep(4000, 8)), 
             tinf   = c(0.5, rep(24, 8)))
# CEP 2000mg q12h inf. 4hrs (DD 4g)
adm4 <- list(time   = seq(0, 12 * 21, by = 12), 
             amount = rep(2000, 22), 
             tinf   = rep(4, 22))

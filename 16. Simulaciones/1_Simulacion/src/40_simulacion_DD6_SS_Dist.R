...
model_ori <- 'data/Modelo_Final_Covar.mlxtran'
...
# Covariable
p3 <- c("SCR_mn" = 0.550, 'omega_SCR' = 0.179)
# Fracción libre
p4 <- c("f" = 0.2)
...
# Grupo de simulación
grp1 <- list(size = 2500, level = 'covariate', treatment = adm1, 
             parameter = list(p1, p2, p3, p4))
grp2 <- list(size = 2500, level = 'covariate', treatment = adm2, 
             parameter = list(p1, p2, p3, p4))
grp3 <- list(size = 2500, level = 'covariate', treatment = adm3, 
             parameter = list(p1, p2, p3, p4))
grp4 <- list(size = 2500, level = 'covariate', treatment = adm4, 
             parameter = list(p1, p2, p3, p4))

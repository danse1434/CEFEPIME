...
##  covariables  ----------------------------------------------------
##  
## Propósito del Script: revisión de comportamiento de algoritmo SCM con 
##  seguimiento de BICc con restricciones en las covariables. El parámetro 
##  V2 hace parte de la estimación SAEM. Sólo se tienen como parámetros 
##  candidatos a Cl y V1.
##  
...
setwd(file.path('F:','Documentos','(Proyecto)_Estudio_PKPD','CEFEPIME', 
                '12. Covariables', 'BASE_MODEL', 'M_SCM_BIC_CL_V1'))

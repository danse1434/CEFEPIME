...
##  covariables  ----------------------------------------------------
##  
## Propósito del Script: revisión de comportamiento de algoritmo COVSAMBA-COSSAC 
##  con seguimiento de BICc con restricciones en las covariables.
##  
...
setwd(file.path('F:','Documentos','(Proyecto)_Estudio_PKPD','CEFEPIME', 
                '12. Covariables', 'BASE_MODEL', 'M_COVSAMBA_BIC'))

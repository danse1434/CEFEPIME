...
##  seguimiento de BICc con restricciones en las covariables. En este caso 
##  se tiene que el parámetro V2 entra dentro de la estimación SAEM. 
##  
...
setwd(file.path('F:','Documentos','(Proyecto)_Estudio_PKPD','CEFEPIME', 
                '12. Covariables', 'BASE_MODEL', 'M_COSSAC_BIC_V2-SAEM'))

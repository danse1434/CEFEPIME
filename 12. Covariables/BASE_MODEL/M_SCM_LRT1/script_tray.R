...
##  seguimiento de LRT sin restricciones en las covariables.
##  
...
setwd(file.path('F:','Documentos','(Proyecto)_Estudio_PKPD','CEFEPIME', 
                '12. Covariables', 'BASE_MODEL', 'ModelSelection_LRT1'))
...
# Se eliminan las primeras 11 filas del archivo
...
G2 <- data4 %>% 
  ...
  geom_vline(xintercept = 552, col = 'black') +

...
pPK = c(V1_pop = 22.12254, V2_pop = 19.82327, 
        Cl_pop = 12.88642, Q_pop = 6.861570,
        omega_V1 = sqrt(log(((0.3162069/100)^2)+1)),
        omega_V2 = sqrt(log(((0.2466035/100)^2)+1)),
        omega_Cl = sqrt(log(((9.122265/100)^2)+1)),
        omega_Q = sqrt(log(((0.7487920/100)^2)+1)),
        a = 0.695, b = 0.225)
